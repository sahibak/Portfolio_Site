...
export default class Projects extends React.Component {
  ...
  allProjects = [
    ...
    },
    {
      name: "My Portfolio",
      description:
        "Developement of my portoflio website to share my develpoment journey.",
      image: { Portfolio },
    ...
    },
    {
      name: "Tick-Tack-Toe",
      description:
        "First pair-programming project at BrainStation, in collobaration with Michael Beaudry.",
      image: { TickTackToe },
