        ...
        return (
            <section className="self">
                ...
                <ul className="self-description">
                    ...
                    <li className="self-description-point">I decided to make a forward leaning decission - to learn web development as my first step in the direction of pursuing my new found interest. By the time I completed my bootcamp at BrainStation (Toronto), it was evident the love for coding had become a passion.</li>
                    <li className="self-description-point"> I hope you enjoy viewing my projects as much as I enjoyed making each one of them.</li>
                </ul>
                </article>
            </section>
        )
