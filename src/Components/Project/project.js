        ...
        return (
            <ul className="project">
                <ul className="project-details">
                    ...
                    <li className="project-description">{this.props.projectDescription}</li>
                ...
                <li className="project-image" ><img className="project-image-display" src={this.props.projectImage} alt="project screenshot"/></li>
            </ul>
